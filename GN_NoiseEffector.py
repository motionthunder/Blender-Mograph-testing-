...
def noiseeffector_node_group():
    """Create a noise effector node group that applies noise-based transformations to geometry"""
    
    # Create new node group
    node_group = bpy.data.node_groups.new(type='GeometryNodeTree', name="NoiseEffector")
    ...
    symmetric_translation_input = node_group.interface.new_socket(name="Symmetric Translation", in_out='INPUT', socket_type='NodeSocketBool')
    ...
    symmetric_rotation_input = node_group.interface.new_socket(name="Symmetric Rotation", in_out='INPUT', socket_type='NodeSocketBool')
    ...
    # Noise parameters
    noise_scale_input = node_group.interface.new_socket(name="Noise Scale", in_out='INPUT', socket_type='NodeSocketFloat')
    noise_scale_input.default_value = 0.5
    noise_scale_input.min_value = 0.1
    noise_scale_input.max_value = 10.0
    
    noise_detail_input = node_group.interface.new_socket(name="Noise Detail", in_out='INPUT', socket_type='NodeSocketFloat')
    noise_detail_input.default_value = 2.0
    noise_detail_input.min_value = 0.0
    noise_detail_input.max_value = 15.0
    
    noise_roughness_input = node_group.interface.new_socket(name="Noise Roughness", in_out='INPUT', socket_type='NodeSocketFloat')
    noise_roughness_input.default_value = 0.5
    noise_roughness_input.min_value = 0.0
    noise_roughness_input.max_value = 1.0
    
    noise_lacunarity_input = node_group.interface.new_socket(name="Noise Lacunarity", in_out='INPUT', socket_type='NodeSocketFloat')
    noise_lacunarity_input.default_value = 2.0
    noise_lacunarity_input.min_value = 0.0
    noise_lacunarity_input.max_value = 10.0
    
    noise_distortion_input = node_group.interface.new_socket(name="Noise Distortion", in_out='INPUT', socket_type='NodeSocketFloat')
    ...
    noise_position_input = node_group.interface.new_socket(name="Noise Position", in_out='INPUT', socket_type='NodeSocketVector')
    noise_position_input.default_value = (0.0, 0.0, 0.0)
    
    noise_xyz_scale_input = node_group.interface.new_socket(name="Noise XYZ Scale", in_out='INPUT', socket_type='NodeSocketVector')
    noise_xyz_scale_input.default_value = (1.0, 1.0, 1.0)
    
    # Animation
    speed_input = node_group.interface.new_socket(name="Speed", in_out='INPUT', socket_type='NodeSocketFloat')
...
# Operator for adding a new NoiseEffector
